  ...
  <div class="modal-dialog modal-lg" style="max-width: 90%; width: auto;">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="modalStudentsLabel">Daftar Siswa</h5>
          ...
          <tbody>
            ...
            ?>
              <tr>
                ...
                <td>
                  <center><?= $rowPelanggaran['poin_pelanggaran'] ?></center>
                </td>
              </tr>
            <?php
            }
...
<div class="modal fade bd-example-modal-lg" id="modal_insert" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><b>Tambah Data Kelas</b></h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
...
<script type="text/javascript">
  function showStudents(id_kelas) {
    $.ajax({
      ...
      data: {
        id_kelas: id_kelas
      }, // Menggunakan id_kelas untuk mendapatkan data siswa
      dataType: 'json',
