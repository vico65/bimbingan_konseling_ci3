...
<div class="modal fade bd-example-modal-lg" id="modal_update" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
   <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <input type="hidden" value="" readonly="" id="id_guru" name="">
        <div class="col-lg-12 col-md-12">
          <div class="form-group bmd-form-group">
            <label style="font-weight: bold;">NIP / NUPTK</label>
            <input type="text" class="w3-input" id="nip_update">
          </div>
        </div>    
        <div class="col-lg-12 col-md-12">
          <div class="form-group bmd-form-group">
            ...
            <table class="table">
              <tbody>
                <tr>
                  ...
                  <th>No Telephone</th>
                  <?php if ($this->session->userdata('level_akses') == 'adminbk') : ?>
                  <th style="width: 180px"><center>Aksi</center></th>
                  <?php endif; ?>
                </tr>
                <?php
                ...
                ?>
                  ...
                  <?php if ($this->session->userdata('level_akses') == 'adminbk') : ?>
                  <td>
                    <button type="button" rel="tooltip" title="Edit data" class="btn btn-primary" onclick="getdataUpdate('<?=$row['id_guru']?>')">
                      <i class="fa fa-pencil"></i>                    
                    </button>                    
                    <button type="button" rel="tooltip" title="Hapus data" onclick="alertdel('<?=$row['id_guru']?>')" class="btn btn-danger">
...
function insertDataGuru(){
    ...
    function AksiUpdate(){
        ...
        setTimeout(function() {
        var datasend = new FormData();
        datasend.append('id_guru',$("#id_guru").val());
